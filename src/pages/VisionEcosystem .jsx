      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 grid lg:grid-cols-3 gap-20 items-center">
        ...
        >
          ...
          <p className="text-white/70 leading-relaxed mb-6">
            ChainX envisions a decentralized world where financial
        ...
        <div className="relative">
          ...
          <p className="text-white/70 mb-4">
            The foundation of <span className="text-white">ChainX</span>.
          ...
          <ul className="text-white/60 space-y-2 mb-6 list-disc list-inside">
            ...
            <li><span className="text-white">Utility:</span> Ecosystem access, governance, payments, staking</li>
            <li><span className="text-white">Goal:</span> Self-sustaining intelligent economy</li>
          </ul>
          ...
          <ul className="text-white/60 space-y-2 list-disc list-inside">
            <li><span className="text-white">AI Vaults:</span> Intelligent liquidity modules</li>
            <li><span className="text-white">Governance DAO:</span> Community-led decisions</li>
            <li><span className="text-white">Developer APIs:</span> Open intelligent tools</li>
          </ul>
        </div>
